    ...
    <div class="register-wrapper">
        <div class="register-container">
            ...
            <form @submit.prevent="handleRegister" class="floating-form">
                ...
                <div class="input-group">
                    <input type="password" id="password" v-model="password" @input="validateInput" required minlength="6" maxlength="20" />
                    <label for="password">密码</label>
                    <span class="highlight"></span>
                </div>
                <div class="input-group">
                    <input type="password" id="confirmPassword" v-model="confirmPassword" @input="validateInput" required minlength="6" maxlength="20" />
                ...
                <div class="form-footer">
                    <span>已有账号？</span>
                    <a href="/login" @click="login">立即登录</a>
                </div>
            </form>
        </div>
    </div>
...
const handleRegister = async () => {
    ...
    try {
        ...
        const errorMessageText = error?.response?.data?.message || error?.message || '注册失败，请稍后重试'
